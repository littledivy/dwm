...
static const Key keys[] = {
	...
	{ MODKEY,                       XK_backslash, spawn,       {.v = roficmd } },
	...
	{ 0,				XF86XK_MonBrightnessUp, spawn_light, SHCMD("brightnessctl set 50+") },
	{ 0,				XF86XK_MonBrightnessDown, spawn_light, SHCMD("brightnessctl set 50-") },
